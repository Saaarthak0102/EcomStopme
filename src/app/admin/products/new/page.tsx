...
export default function NewProductPage() {
  ...
  return (
    <div className="p-8 max-w-2xl">
      <h1 className="text-2xl font-bold text-[#1B1C1C] mb-6">Add New Product</h1>
      ...
      <form onSubmit={handleSubmit(onSubmit as any)} className="flex flex-col gap-6">
        ...
        >
          {loading ? <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin" /> : "Create Product"}
        </button>
      </form>
